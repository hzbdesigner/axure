    ...
    PPTBox.prototype =
    {
        ...
        _init : function (){
            ...
            for(var i=0;i<this._box.length;i++){
                ...
                imageHTML ="<div class='bitdiv "+((i==0)?"mcurimg":"defimg")+"' title ="+parame.title+" src='bit01.gif' "+picstyle+" onclick = \""+eventstr+".clickPic("+i+")\"  onmouseover=\""+eventstr+".mouseoverPic("+i+")\"></div>" + imageHTML;
            }
        ...
        changeIndex : function(idx){
            ...
            imgs[this._box.length-1-idx].className = "bitdiv mcurimg";
            this._curIndex = idx;
        },
